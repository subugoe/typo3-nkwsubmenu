...
$tempColumns = Array (
	...
	"tx_nkwsubmenu_hideinfobox" => Array (
		"exclude" => 1,
		"label" => "LLL:EXT:nkwsubmenu/locallang_db.xml:pages.tx_nkwsubmenu_hideinfobox",
		"config" => Array (
			"type" => "check",
		)
	),
...
t3lib_extMgm::addToAllTCAtypes("pages","tx_nkwsubmenu_in_menu;;;;1-1-1,tx_nkwsubmenu_picture,tx_nkwsubmenu_picture_follow,tx_nkwsubmenu_picture_nofollow,tx_nkwsubmenu_knot,tx_nkwsubmenu_usecontent,tx_nkwsubmenu_hideinfobox,tx_nkwsubmenu_knotheader");
